...
const CheckOut = () => {
    ...
    return (
        <div>
            <h2 className="text-3xl text-center">Check Out</h2>
            <h2 className="text-2xl">Book services: {title}</h2>
            ...
            <form onSubmit={handleBookServices}>
                ...
                <div className="form-control mt-6">
                    ...
                    <input className='btn btn-success btn-block' type="submit" value="Order Confirm" />
                </div>
            </form>
        </div>
    );
